      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        {projectData.map((item, index) => (
          ...
          >
            ...
            <div className="relative h-64 lg:h-80 overflow-hidden bg-gradient-to-br from-blue-50 to-gray-100">
              <Image
                src={item.image}
            ...
            <div className="p-6 lg:p-8">
              ...
              {/* Project Title */}
              <h3 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                {item.title}
            ...
            {/* Decorative Elements */}
            <div className="absolute top-4 right-4 w-16 h-16 bg-blue-100 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-0 group-hover:scale-100"></div>
            <div className="absolute bottom-4 left-4 w-8 h-8 bg-blue-200 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 transform scale-0 group-hover:scale-100 delay-100"></div>
          </div>
        ))}
      </div>
      ...
      <div className="mt-16 text-center">
        <div className="bg-gradient-to-r from-blue-50 to-gray-50 rounded-2xl p-8 lg:p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold transition-colors duration-200 flex items-center justify-center gap-2"
            >
              <ExternalLink size={20} />
              Start a Project
            </Link>
            <Link
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/Rohith208"
            >
              <button className="px-8 py-3 bg-transparent border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-600 hover:text-white font-semibold transition-all duration-200">
                View More Work
              </button>
            </Link>
          </div>
