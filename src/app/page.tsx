...
export const metadata: Metadata = {
  title: "Rohith | Frontend Web Developer Portfolio",
  description:
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="text-center lg:text-left lg:w-1/2 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-6 animate-fade-in-up delay-700">
                <Link
                  href="/contact"
                  className="group px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-semibold transition-all duration-300 transform  hover:shadow-lg flex items-center gap-2"
                >
                  Get In Touch
                ...
                <Link
                  ...
                  className="group px-8 py-4 bg-transparent border-2 border-gray-300 text-gray-700 rounded-xl hover:border-blue-600 hover:text-blue-600 font-semibold transition-all duration-300 transform  flex items-center gap-2"
                >
                  <Download size={20} />
                  Download CV
                </Link>
