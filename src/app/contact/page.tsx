...
export const metadata: Metadata = {
  title: "Contact | Rohith - Frontend Developer",
  description:
    "Get in touch with Rohith for web development projects, collaborations, and job opportunities.",
  keywords: [
    "Contact Rohith",
  ...
  return (
    <main className="flex-none h-auto px-4 md:px-8 lg:px-28 relative w-[100%] m-auto">
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/3 w-16 h-16 bg-blue-300 rounded-full opacity-20 animate-pulse delay-500"></div>
        ...
        <div className="relative z-10">
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="text-center lg:text-left lg:w-1/2 space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl lg:text-7xl md:text-6xl font-bold leading-tight animate-fade-in-up">
                  <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent animate-fade-in-up delay-200">
                    Get In
                  </span>
                  <span className="text-gray-800 animate-fade-in-up delay-300">
                    Touch
                  </span>
                  <span className="text-blue-600 animate-fade-in-up delay-400">
                    .
                  </span>
                </h1>
              </div>
              ...
              <div className="space-y-4 animate-fade-in-up delay-700">
                {/* Email */}
                <Link
                  href="mailto:rohithganesan208@gmail.com"
                  className="group flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover:border-blue-200"
                >
            ...
            <div className="relative flex items-center justify-center w-72 md:w-80 lg:w-96 h-72 md:h-80 lg:h-96 animate-fade-in-up delay-300">
              ...
              <div className="relative w-full h-full rounded-full border-4 border-blue-300 shadow-xl overflow-hidden">
                <Image
                  src={profileImg}
                  alt="Rohith g - Frontend Developer"
                ...
                {/* Floating Elements */}
                <div className="absolute -top-2 -right-2 w-8 h-8 bg-blue-600 rounded-full animate-bounce delay-1000"></div>
                <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-blue-400 rounded-full animate-bounce delay-1500"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-gray-50 rounded-2xl p-8 lg:p-12 border border-blue-100">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="mailto:rohithganesan208@gmail.com"
                className="group px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2"
              >
                <Send className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" />
                Send Message
              </Link>
              <Link
                href="/RohithG_Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="group px-8 py-4 bg-transparent border-2 border-blue-600 text-blue-600 rounded-xl hover:bg-blue-600 hover:text-white font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
              >
                Download Resume
              </Link>
            </div>
