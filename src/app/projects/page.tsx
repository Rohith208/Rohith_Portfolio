...
export const metadata: Metadata = {
  title: "Projects | Rohith - Frontend Developer",
  description:
    "Explore projects developed by Rohith, a frontend web developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
  ...
  return (
    <main className="flex-none h-auto px-4 md:px-8 lg:px-28 relative w-[100%] m-auto">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-10 w-20 h-20 bg-blue-200 rounded-full opacity-30 animate-pulse delay-1000"></div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl lg:text-8xl md:text-6xl font-bold text-gray-800">
                My <span className="text-blue-600">Best</span> Creations
              </h1>
            </div>
          </div>
          ...
          <div className="max-w-4xl">
            <p className="text-gray-800 text-xl lg:text-2xl px-2 border-l-4 lg:border-l-8 border-blue-600 mb-8">
