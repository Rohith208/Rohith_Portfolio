...
export const metadata: Metadata = {
  title: "About | Rohith - Frontend Developer",
  description:
    "Learn more about Rohith, a frontend web developer specializing in React, TypeScript, Ionic and modern web technologies.",
  keywords: [
    "About Rohith",
    "Frontend Developer",
    "React Developer",
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed max-w-4xl mx-auto animate-fade-in-up delay-200 border-l-4 lg:border-l-8 border-blue-600 pl-6 lg:pl-8">
          ...
          {/* Mission Statement */}
          <div className="bg-gradient-to-r from-blue-50 to-gray-50 rounded-2xl p-8 lg:p-12 border border-blue-100 animate-fade-in-up delay-700">
